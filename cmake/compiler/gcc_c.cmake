...
set(WIN32_GUI_GCC_C_VERSION_MIN 14 CACHE STRING "Minimum gcc compiler version")

# Confirm supported gcc compiler version
if(CMAKE_C_COMPILER_VERSION VERSION_LESS ${WIN32_GUI_GCC_C_VERSION_MIN})
    message(FATAL_ERROR "Incompatible version of GCC C compiler for ${CMAKE_PROJECT_NAME}.")
endif()

# Compiler feature configuration target
add_library(WIN32_GUI_gcc_c_features INTERFACE)
# Compiler diagnostics configuration target
add_library(WIN32_GUI_gcc_c_warnings INTERFACE)
# General compiler configuration target
add_library(WIN32_GUI_gcc_c_options INTERFACE)
# Preprocessor definitions target
add_library(WIN32_GUI_gcc_c_defines INTERFACE)

# Set C standard version
target_compile_features(
    WIN32_GUI_gcc_c_features
...
add_library(WIN32_GUI_gcc_c_bundle INTERFACE)

target_link_libraries(
    WIN32_GUI_gcc_c_bundle
